  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-lg font-bold text-[#1B2A45]">Nueva propiedad</h1>
      </div>
      ...
      <div className="mt-4 flex items-start gap-2.5 bg-[#B08D57]/8 border border-[#B08D57]/20 rounded-xl px-4 py-3">
        <svg viewBox="0 0 24 24" className="w-4 h-4 text-[#B08D57] shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="2">
          <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
        </svg>
        <p className="text-[12px] text-[#96784A] leading-relaxed">
